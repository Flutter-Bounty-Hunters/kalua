...
''';
    ...
    test('tokenize a single line range', () {
      ...
      final tokens = lexer.tokenizePartial(fullText: code, range: range)!;
    ...
    test('tokenize multiple lines', () {
      ...
      expect(tokens.length, lexer.tokenize(code).length);
    });
  });
}
